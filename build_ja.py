...
PAGE_META = {
    ...
    'hwp-viewer.html': {
        'title': 'HWP ビューア 無料オンライン インストール不要 — ハングルなしで.hwp/.hwpxファイルを開く | WooaViewer',
        'desc': 'ハングル(Hancom Office)なしでブラウザで.hwp、.hwpxファイルを無料で開く。テキスト、表、画像を表示。ファイルはサーバーに送信されません — 100%プライベート、インストール不要。',
        'kw': 'HWPビューア, ハングルビューア, hwpを開く, hwpxを開く, 無料HWPビューア, オンラインハングルビューア, 韓国語文書ビューア',
        'h1': 'HWP ビューア — ハングルファイルを無料でオンラインで開く',
        'tool_desc': '.hwpまたは.hwpxファイルをアップロードして、ハングル(Hancom Office)なしで開いて読む。テキスト、表、画像を表示します。すべての処理はブラウザ内で行われます。',
    },
    'xlsx-viewer.html': {
