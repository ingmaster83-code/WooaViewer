...
PAGE_META = {
    ...
    'hwp-viewer.html': {
        'title': 'HWP Viewer Free Online – Open Hangul (HWP/HWPX) Files Without Hancom Office | WooaViewer',
        'desc':  'Open .hwp and .hwpx Hangul word processor files for free in your browser without Hancom Office. Text, tables, and images are rendered. Files are never sent to a server — 100% private.',
        'kw':    'HWP viewer, Hangul viewer, open hwp, open hwpx, free HWP viewer, online Hangul viewer, HWP file viewer, open hwp without Hancom, hwpx online viewer, Korean document viewer',
        'og_title': 'HWP Viewer Free Online – Open Hangul Files Without Hancom Office | WooaViewer',
        'og_desc':  'Open .hwp and .hwpx Hangul files in your browser for free. No Hancom Office needed. Files never sent to a server.',
        'app_name': 'HWP Viewer',
        'faq': [
            ('Do I need Hancom Office (Hangul) installed?',
             'No. You can open .hwp and .hwpx files directly in your browser without any software installed.'),
            ('Is all formatting perfectly displayed?',
             'Most text, tables, and images render accurately, but very complex objects or special features may look slightly different. Use this for content preview purposes.'),
            ('Is my file uploaded to a server?',
             'No. All processing is done locally in your browser. Your document is never sent anywhere.'),
        ],
        'h1': 'HWP Viewer – Open Hangul Files Free Online',
        'tool_desc': 'Upload a .hwp or .hwpx file to open and read it without Hancom Office. Text, tables, and images are displayed. All processing happens in your browser.',
        'breadcrumb': 'HWP Viewer',
    ...
    'pptx-viewer.html': {
        'title': 'PPTX Viewer Free Online – Open PowerPoint Slides Without PowerPoint | WooaViewer',
        'desc':  'Open .pptx PowerPoint files for free in your browser without Microsoft PowerPoint. View slide titles, body text, and navigate slides. Files never sent to a server — 100% private.',
        'kw':    'PPTX viewer, PowerPoint viewer, open PPTX, open PowerPoint, free PPTX viewer, online PowerPoint viewer, PPTX online, open PowerPoint without PowerPoint, presentation viewer, slide viewer',
        'og_title': 'PPTX Viewer Free Online – Open PowerPoint Without PowerPoint | WooaViewer',
        'og_desc':  'Open .pptx PowerPoint files in your browser for free. View slide content. Files never sent to a server.',
        'app_name': 'PPTX Viewer',
        'faq': [
            ('Do I need Microsoft PowerPoint installed?',
             'No. You can open .pptx files directly in your browser without any software installed.'),
            ('Can I see all slides?',
             'Yes. All slide titles and body text are extracted and displayed. Grid and list view are both available.'),
            ('Is my file uploaded to a server?',
             'No. All processing happens locally in your browser. Your file is never sent anywhere.'),
        ],
        'h1': 'PPTX Viewer – Open PowerPoint Files Free Online',
        'tool_desc': 'Upload a .pptx file to view all slides without PowerPoint. See slide titles and text content in grid or list view. All processing runs in your browser.',
        'breadcrumb': 'PPTX Viewer',
        'cross_banner_text': 'Need to view Word or Excel files too?',
        'cross_banner_link_text': '📝 DOCX Viewer →',
        'cross_banner_href': '../docx-viewer.html',
    },
    'eml-viewer.html': {
        'title': 'EML Viewer Free Online – Open Email Files, View Body & Attachments | WooaViewer',
        'desc':  'Open .eml email files for free in your browser. View sender, recipient, subject, date, and full email body (HTML and plain text). Attachment list displayed. Files never sent to a server.',
        'kw':    'EML viewer, open EML file, email file viewer, online EML viewer, free EML viewer, MIME viewer, Outlook email viewer, eml email reader, email viewer browser, attachment viewer',
        'og_title': 'EML Viewer Free Online – Open Email Files, View Body & Attachments | WooaViewer',
        'og_desc':  'Open .eml email files in your browser. View sender, subject, body, and attachments. Free, no server upload.',
        'app_name': 'EML Viewer',
        'faq': [
            ('What email clients create .eml files?',
             'EML files are created by Outlook, Thunderbird, Apple Mail, and most standard email clients.'),
            ('Can I see HTML email content?',
             'Yes. Both HTML and plain text versions of the email body are displayed when available.'),
            ('Is my email file uploaded to a server?',
             'No. All processing happens locally in your browser. Your email content is never sent anywhere.'),
        ],
        'h1': 'EML Viewer – Open Email Files Free Online',
        'tool_desc': 'Upload an .eml file to view the sender, recipient, subject, date, and full email body. HTML and plain text views supported. Attachment list shown. All runs in your browser.',
        'breadcrumb': 'EML Viewer',
        'cross_banner_text': 'Need to view Word or PDF documents?',
        'cross_banner_link_text': '📝 DOCX Viewer →',
        'cross_banner_href': '../docx-viewer.html',
    },
    'yaml-viewer.html': {
        'title': 'YAML Viewer Free Online – View YAML Files in Tree Structure, Collapse & Expand | WooaViewer',
        'desc':  'Upload or paste a YAML (.yaml/.yml) file to view it as an interactive tree structure. Collapse/expand nodes, supports config files and CI/CD pipelines. Free, no server upload.',
        'kw':    'YAML viewer, open YAML file, YAML tree viewer, online YAML viewer, free YAML viewer, YML viewer, YAML parser, YAML visualizer, YAML explorer, config file viewer, YAML formatter',
        'og_title': 'YAML Viewer Free Online – Tree View, Collapse & Expand | WooaViewer',
        'og_desc':  'View YAML files as an interactive tree. Collapse/expand nodes. Supports config and CI/CD files. Free, no server upload.',
        'app_name': 'YAML Viewer',
        'faq': [
            ('What YAML files are supported?',
             'Any .yaml or .yml file is supported, including Docker Compose, GitHub Actions, Kubernetes configs, and application settings.'),
            ('Can I paste YAML text directly?',
             'Yes. Switch to the paste mode to type or paste YAML text without uploading a file.'),
            ('Is my YAML file uploaded to a server?',
             'No. All processing happens locally in your browser. Your file is never sent anywhere.'),
        ],
        'h1': 'YAML Viewer – Free Online Tree View',
        'tool_desc': 'Upload or paste a YAML file to display it as an interactive tree. Collapse/expand nodes to browse the structure. Supports all .yaml and .yml files. All runs in your browser.',
        'breadcrumb': 'YAML Viewer',
        'cross_banner_text': 'Need to view JSON or XML files too?',
        'cross_banner_link_text': '🗂️ JSON Viewer →',
        'cross_banner_href': '../json-viewer.html',
    },
    'diff-viewer.html': {
        'title': 'Diff Viewer Free Online – Compare Two Text Files, Highlight Changes | WooaViewer',
        'desc':  'Paste or upload two text files to compare them and highlight added, deleted, and changed lines. Filter by change type. Free, no server upload, pure browser-based comparison.',
        'kw':    'diff viewer, text compare, file compare, diff checker, online diff tool, free diff viewer, compare two files, text diff, code diff, diff file viewer, compare text online',
        'og_title': 'Diff Viewer Free Online – Compare Two Text Files, Highlight Changes | WooaViewer',
        'og_desc':  'Compare two text files and highlight added, deleted, and changed lines. Filter by change type. Free, no server upload.',
        'app_name': 'Diff Viewer',
        'faq': [
            ('What types of files can I compare?',
             'Any plain text content can be compared — source code, configuration files, documents, logs, and more.'),
            ('Can I filter to see only additions or deletions?',
             'Yes. Use the filter buttons to show all changes, additions only, deletions only, or modifications only.'),
            ('Is my content sent to a server?',
             'No. All comparison processing happens locally in your browser. Your text is never sent anywhere.'),
        ],
        'h1': 'Diff Viewer – Compare Text Files Free Online',
        'tool_desc': 'Paste or upload two text files to compare them side by side. Added lines are shown in green, deleted lines in red. Filter by change type. All runs in your browser.',
        'breadcrumb': 'Diff Viewer',
        'cross_banner_text': 'Need to view JSON or YAML files?',
        'cross_banner_link_text': '🗂️ JSON Viewer →',
        'cross_banner_href': '../json-viewer.html',
    },
    'zip-viewer.html': {
...
COMMON = [
    ...
    ('<div class="tool-name">PPTX 뷰어</div>', '<div class="tool-name">PPTX Viewer</div>'),
    ('<div class="tool-name">EML 뷰어</div>', '<div class="tool-name">EML Viewer</div>'),
    ('<div class="tool-name">YAML 뷰어</div>', '<div class="tool-name">YAML Viewer</div>'),
    ('<div class="tool-name">Diff 뷰어</div>', '<div class="tool-name">Diff Viewer</div>'),
    ...
    ('<div class="tool-desc">PowerPoint 없이 .pptx 슬라이드 열어보기</div>',
     '<div class="tool-desc">Open .pptx slides without PowerPoint</div>'),
    ('<div class="tool-desc">.eml 이메일 파일 발신자·본문·첨부파일 확인</div>',
     '<div class="tool-desc">View .eml email sender, body & attachments</div>'),
    ('<div class="tool-desc">.yaml / .yml 파일을 트리 구조로 보기</div>',
     '<div class="tool-desc">View .yaml / .yml files as an interactive tree</div>'),
    ('<div class="tool-desc">두 텍스트 파일의 차이점(변경·추가·삭제) 비교</div>',
     '<div class="tool-desc">Compare two text files and highlight differences</div>'),
    ...
    ('<span>PPTX 뷰어</span>', '<span>PPTX Viewer</span>'),
    ('<span>EML 뷰어</span>', '<span>EML Viewer</span>'),
    ('<span>YAML 뷰어</span>', '<span>YAML Viewer</span>'),
    ('<span>Diff 뷰어</span>', '<span>Diff Viewer</span>'),
    ...
    # PPTX viewer specifics
    ('PPTX 파일을 여기에 끌어다 놓으세요', 'Drop your PPTX file here'),
    ('.pptx 형식을 지원합니다', 'Supports .pptx format'),
    ('<button class="view-btn active" id="btnGrid" onclick="setView(\'grid\')">그리드 보기</button>',
     '<button class="view-btn active" id="btnGrid" onclick="setView(\'grid\')">Grid View</button>'),
    ('<button class="view-btn" id="btnList" onclick="setView(\'list\')">리스트 보기</button>',
     '<button class="view-btn" id="btnList" onclick="setView(\'list\')">List View</button>'),
    ('슬라이드', 'Slides'),

    # EML viewer specifics
    ('EML 파일을 여기에 끌어다 놓으세요', 'Drop your EML file here'),
    ('.eml 형식을 지원합니다', 'Supports .eml format'),
    ('>발신자<', '>From<'),
    ('>수신자<', '>To<'),
    ('>참조<', '>Cc<'),
    ('>날짜<', '>Date<'),
    ('>제목<', '>Subject<'),
    ('📎 첨부파일', '📎 Attachments'),
    ('본문 내용이 없습니다.', 'No body content found.'),

    # YAML viewer specifics
    ('YAML 파일을 여기에 끌어다 놓으세요', 'Drop your YAML file here'),
    ('.yaml, .yml 형식을 지원합니다', 'Supports .yaml, .yml format'),

    # Diff viewer specifics
    ('<h3>원본 (A)</h3>', '<h3>Original (A)</h3>'),
    ('<h3>변경 후 (B)</h3>', '<h3>Modified (B)</h3>'),
    ('>전체<', '>All<'),
    ('>추가만<', '>Added<'),
    ('>삭제만<', '>Deleted<'),
    ('>변경만<', '>Changed<'),
